...
- **[security-audit](./security-audit/SKILL.md)**: Deep, multi-vector security audit of a whole project or a scoped area, driven by OWASP-aligned attack-vector checklists and parallel sub-agents; ends in a structured, prioritised findings report with a fix plan.
...
- **[fix-from-evidence](./fix-from-evidence/SKILL.md)**: Work backwards from production evidence (APM traces, error logs, stack traces, crash reports) to the defect: parse the evidence, localise the code path, then hand a confirmed hypothesis to the diagnosis loop. Stack-agnostic — backend or frontend.
- **[research](./research/SKILL.md)**: Investigate a question against high-trust primary sources and capture the findings as a cited Markdown file in the repo, run as a background agent.
- **[tdd](./tdd/SKILL.md)**: Test-driven development with a red-green-refactor loop. Builds features or fixes bugs one vertical slice at a time.
- **[coding-standards](./coding-standards/SKILL.md)**: Language-agnostic implementation standards applied while writing or changing code: short functions, reuse before reinvention, performance and security defaults, and honest naming. Complements `/code-review`, which checks the same qualities after the fact.
